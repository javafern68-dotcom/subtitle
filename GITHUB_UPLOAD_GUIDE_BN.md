# GitHub Build Guide — V3.0.1 Voice Fallback
...
১. Repository খুলুন।  
২. ডান পাশের `Releases` থেকে `Bangla Subtitle Studio V3.0.1 Voice Fallback` খুলুন।  
৩. `Bangla_Subtitle_Studio_Voice_Fallback_Setup_V3.0.1.exe` download করুন।  
