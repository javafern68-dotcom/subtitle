# GitHub Build Guide — V3.2.1 Natural Synced Dubbing
...
১. Repository খুলুন।  
২. ডান পাশের `Releases` থেকে `Bangla Subtitle Studio V3.2.1 Natural Synced Dubbing` খুলুন।  
৩. `Bangla_Subtitle_Studio_Natural_Synced_Dubbing_Setup_V3.2.1.exe` download করুন।  
