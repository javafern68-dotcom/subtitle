# GitHub Build Guide — V2.4.1 Multilanguage Fixed
...
১. Repository খুলুন।  
২. ডান পাশের `Releases` থেকে `Bangla Subtitle Studio V2.4.1 Multilanguage Fixed` খুলুন।  
৩. `Bangla_Subtitle_Studio_Multilanguage_Fixed_Setup_V2.4.1.exe` download করুন।  
