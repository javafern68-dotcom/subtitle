# GitHub Build Guide — V2.4 Multilanguage
...
১. Repository খুলুন।  
২. ডান পাশের `Releases` থেকে `Bangla Subtitle Studio V2.4.0 Multilanguage` খুলুন।  
৩. `Bangla_Subtitle_Studio_Multilanguage_Setup_V2.4.exe` download করুন।  
