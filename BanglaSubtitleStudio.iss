...
OutputDir=installer
OutputBaseFilename=Bangla_Subtitle_Studio_Professional_Timeline_Setup_V4.0.0
Compression=lzma2
...
VersionInfoDescription=Professional multi-track video editor with offline Bangla subtitle and voice tools
